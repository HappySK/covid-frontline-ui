...
class EditVolunteers extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      name: "",
  ...
  componentDidMount() {
    ...
    console.log(_id);
    axios
      .get(`https://api.covidfrontline.net/volunteers/update_volunteers/${_id}`)
      .then((res) => {
  ...
  handleSubmit(e) {
    ...
    if (this.validator.allValid()) {
      ...
      axios
        .put(
          `https://api.covidfrontline.net/volunteers/update_volunteers_patch/${_id}`,
          menu
        )
      ...
      <div>
        ...
        <div className="admin-wrapper col-12">
          <div className="admin-content">
            <div className="admin-head">Edit Volunteers</div>
            {this.state.loading ? (
