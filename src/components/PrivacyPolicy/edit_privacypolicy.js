      ...
      <div>
        ...
        <div className="admin-wrapper col-12">
          <div className="admin-content">
            <div className="admin-head">Edit Privacy Policy</div>
            {this.state.loading ? (
                      ...
                      <div className="col-lg-12 p-0">
                        ...
                        /> */}
                          <ReactQuill
                            ...
                            value={this.state.description}
                            modules={EditPrivacyPolicy.modules}
                            formats={EditPrivacyPolicy.formats}
                            bounds={".app"}
