          ...
          <>
            <tr key={index}>
              ...
              <td>
                {menu.status == true ? (
                  <button
                    onClick={e => {
                      ...
                      axios
                        .get(
                          `https://api.covidfrontline.net/volunteers/suspenduser/${menu._id}`
                        )
                  ...
                  <button
                    onClick={e => {
                      ...
                      axios
                        .get(
                          `https://api.covidfrontline.net/volunteers/makeliveuser/${menu._id}`
                        )
                        .then(function (response) {
                          window.location.reload();
                ...
                <Link to={`/edit_volunteers/${menu._id}`}>
