...
class EditTermsOfservice extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      description: "",
      ...
      <div>
        ...
        <div className="admin-wrapper col-12">
          <div className="admin-content">
            <div className="admin-head">Edit Terms Of Service</div>
            {this.state.loading ? (
                      ...
                      <div className="col-lg-12 p-0">
                        ...
                        /> */}
                          <ReactQuill
                            ...
                            value={this.state.description}
                            modules={EditTermsOfservice.modules}
                            formats={EditTermsOfservice.formats}
                            bounds={".app"}
